...
* [Score a Passport (Example)](https://github.com/gitcoinco/passport-scorer/tree/main/examples/example-score-a-passport) ⭐ 181 | 🐛 57 | 🌐 Jupyter Notebook | 📅 2026-09-21: Simple, HTML and JavaScript example of how to score a passport using the [Scorer API](https://www.scorer.gitcoin.co/).
* [Score Integration](https://github.com/gitcoinco/passport-scorer/tree/main/examples/score-showcase) ⭐ 181 | 🐛 57 | 🌐 Jupyter Notebook | 📅 2026-09-21 A Next.js app demonstrating how to integrate a user's passport score.
  * [Demo](https://score-showcase.vercel.app/)
* [Score Gating](https://github.com/gitcoinco/passport-scorer/tree/main/examples/score-gating) ⭐ 181 | 🐛 57 | 🌐 Jupyter Notebook | 📅 2026-09-21 A Next.js app demonstrating how to gate content.
  * [Demo](https://score-gating.vercel.app/)
* [Airdrop](https://github.com/gitcoinco/passport-scorer/tree/main/examples/airdrop) ⭐ 181 | 🐛 57 | 🌐 Jupyter Notebook | 📅 2026-09-21 A Next.js app for collecting addresses for an airdrop.
...
* [Google OAuth Stamp](https://github.com/gitcoinco/passport/pull/31) ⭐ 1,223 | 🐛 840 | 🌐 TypeScript | 📅 2026-09-22
* [ENS Stamp](https://github.com/gitcoinco/passport/pull/71) ⭐ 1,223 | 🐛 840 | 🌐 TypeScript | 📅 2026-09-22
* [Proof of Humanity Stamp](https://github.com/gitcoinco/passport/pull/75) ⭐ 1,223 | 🐛 840 | 🌐 TypeScript | 📅 2026-09-22
* [Twitter OAuth Stamp](https://github.com/gitcoinco/passport/pull/87) ⭐ 1,223 | 🐛 840 | 🌐 TypeScript | 📅 2026-09-22
* [Facebook Stamp](https://github.com/gitcoinco/passport/pull/94) ⭐ 1,223 | 🐛 840 | 🌐 TypeScript | 📅 2026-09-22
* [BrightId Stamp](https://github.com/gitcoinco/passport/pull/126) ⭐ 1,223 | 🐛 840 | 🌐 TypeScript | 📅 2026-09-22
